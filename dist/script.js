...
var Keyboard = /*#__PURE__*/function () {
  function Keyboard() {
    ...
    this.model = new _js_Model__WEBPACK_IMPORTED_MODULE_0__["Model"]();
    this.view = new _js_View__WEBPACK_IMPORTED_MODULE_1__["View"]();
    this.controller = new _js_Controller__WEBPACK_IMPORTED_MODULE_2__["Controller"]();
  }
...
var Model = /*#__PURE__*/function () {
  ...
  _createClass(Model, [{
    ...
    value: function changeLine(_char) {
      this.line = this.line.slice(0, this.cursorPosition) + _char + this.line.slice(this.cursorPosition, this.line.length);
  ...
  _createClass(View, [{
    ...
    value: function drawKeyboard(numberOfKeys, specialKeys) {
      ...
      var _loop = function _loop(i) {
        ...
        specialKeys && Object.keys(specialKeys).forEach(function (specialKey) {
        ...
        if (!key.innerText) key.innerText = i; //creating block for arrowUp and arrowDown keys
